...
export default function BoardClient() {
  ...
  // Sidebar never shows skeleton here — AppSidebar handles its own loading state.
  // Only the main content area shows skeleton while the board loads.
  // This prevents the jarring sidebar flash: skeleton → real → skeleton → real.
  const mainContent = (() => {
    if (board.isLoading) {
      return (
